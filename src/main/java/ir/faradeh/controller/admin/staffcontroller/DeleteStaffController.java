 ...
 * @author Mohammad
 */
@WebServlet(name = "DeleteStaffController", urlPatterns = {"/privates/admin/staff/delete"})
public class DeleteStaffController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            personBusiness.removePerson(id);
            response.sendRedirect("/Faradeh/privates/admin/staff/staffs");
        } catch (FailedDeleteUserException ex) {
