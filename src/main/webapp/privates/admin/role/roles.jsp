...
<html>
    ...
    <body>
        <table class="table-responsive table-bordered">
            <tr>
                <td>شناسه</td>
                <td>نام سمت به فارسی</td>
                <td>نام سمت به انگلیسی</td>
                <td>ویرایش</td>
                <td>حذف</td>
            </tr>
            <%
                List<RoleEntity> list = (List<RoleEntity>) request.getAttribute("list");
                for (RoleEntity entity : list) {
            %>
            <tr>
                <td><%=entity.getId().toHexString()%></td>
                <td><%=entity.getRoleNameFa()%></td>
                <td><%=entity.getRoleNameEn()%></td>
                <td>
                    <a href="/Faradeh/privates/admin/role/edit?Id=<%=entity.getId().toHexString()%>">ویرایش</a>
                </td>
                <td>
                    <form action="/Faradeh/privates/admin/role/delete" method="post" >
        ...
        <br/>
        <a href="/Faradeh/privates/admin/role/addrole.html">اضافه کردن سمت جدید</a>
    </body>
</html>
